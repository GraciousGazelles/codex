...
fn create_exec_command_tool(
    ...
    ToolSpec::Function(ResponsesApiTool {
        ...
        description: if cfg!(windows) {
            ...
            "Runs a command in a PTY, returning output or a session ID for ongoing interaction. Use `wait_until_terminal=true` to block until the process exits or the wait window elapses.".to_string()
        },
        strict: false,
        defer_loading: None,
