...
impl ChatComposer {
    ...
    ///
    /// Inline-arg commands are initially dispatched using the raw draft. Once the command handler
    /// accepts and executes the command, this helper performs the usual
...
程序员 与 Unicode 同行";
    ...
    #[test]
    fn slash_command_while_task_running_dispatches_for_queueing() {
        use crossterm::event::KeyCode;
        use crossterm::event::KeyEvent;
        use crossterm::event::KeyModifiers;
